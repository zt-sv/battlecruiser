...
class Component extends BaseClass {
    ...
    get templatePath() {
        var
            defaultPath = `${this.constructor.path || __dirname}/templates/default.handlebars`;
     ...
     * @param   {Component} dependency.component    Link to component class
     ...
     * @param   {Source} source.source  Link to source class
    ...
    compilePartials(callback) {
        ...
        async.forEachOf(this.partials, (value, key, done) => {
            var
                partialPath = path.resolve(`${this.constructor.path || __dirname}/templates/`, value);
    ...
    getClientTemplates(callback) {
        ...
        async.forEachOf(this.clientTemplates, (value, key, done) => {
            var
                templatePath = path.resolve(`${this.constructor.path || __dirname}/templates/`, value);
