...
var
     ...
     *
     * @param   {Object}  object    Object with internal storage
     *
     * @returns {Object}            Internal storage for the object
     */
        ...
        var
            ...
            setter = newValue => {
                if (h.isArray(validator)) {
                    validator.forEach(checker => checker.check(propName, newValue));
                } else {
