...
class Component extends BaseClass {
    ...
    getRawTemplate(templatePath, callback) {
         ...
         *
         * @param       {Error|null}   err           Thrown error
         * @param       {string|null}  rawTemplate   Template as text
         */
    ...
    getCompiledTemplate(templatePath, callback) {
         ...
         *
         * @param       {Error|null}   err       Thrown error
         * @param       {string|null}  template  Compiled template as function
         */
        ...
        this.getRawTemplate(templatePath, (err, rawTemplate) => {
            ...
            compiled = this.templateСompiler.compile(rawTemplate);
    ...
    compilePartials(callback) {
         ...
         *
         * @param       {Error|null}   err       Thrown error
         * @param       {Object|null}  partials  Compiled partials as function
         */
        ...
        async.forEachOf(this.partials, (value, key, done) => {
            ...
            this.getCompiledTemplate(partialPath, (err, partial) => {
                ...
                this.templateСompiler.registerPartial(key, partial);
                done(null, partial);
            });
        }, callback);
    }
    ...
    render(callback) {
        ...
        async.parallel(
            ...
            (err, res) => {
                ...
                return callback(res.template(this.data));
            }
        );
    }
 ...
 *
 * @property    templateСompiler
 * @type        {handlebars}
 */
Component.prototype.templateСompiler = handlebars.create();

/**
 * Local template partials declaration. Is empty object by default.
 * Should be an object, where the key is the name of partial and the value is the path relative to component root.
 *
 * @example
 * this.partials = {
 *      'foo': 'bar.handlebars'
 ...
 * @type        {Object}
 */
Component.prototype.clientTemplates = {};
 ...
 * @type        {boolean}
 */
Component.prototype[_useTemplatesCache] = config.useTemplatesCache;
 ...
 * @type        {string|null}
 */
Component.prototype[_templatePath] = null;
 ...
 */
Component.prototype[_dependencies] = [];
