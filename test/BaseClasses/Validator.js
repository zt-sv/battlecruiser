...
//var
//    chai = require('chai'),
//    Validator = require('../../lib/PropChecker/checkers'),
//    expect = chai.expect,
//    should = chai.should(),
//
//    methods = [
...
//
//            invalidValues.forEach(value => {
//                expect(() => Validator.isArrayOf(value))
...
//
//            invalidValues.forEach(value => {
//                expect(() => isArrayOfNumber('testKey', [value]))
//                          .to.throw(Error, 'Property "testKey" have wrong element in array');
//            });
//        });
//    });
//
